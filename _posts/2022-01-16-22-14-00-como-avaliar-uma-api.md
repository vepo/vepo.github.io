...
<!--Acho que esta esquisito dar tantas perguntas, quer dizer, você pergunta:
"- Como avaliar uma API?
Antes disso, nosso primeiro desafio...
- Existe alguma definição de padrões de projeto para APIs REST?
Antes disso, a primeira pergunta é..
- De onde vem o conceito de padrões de projeto"
Quer dizer, perguntas são um bom recurso para introduzir uma ideia didaticamente, mas aqui foi usado em excesso.
-->
...
![Padrão Gradiente de Intimidade descrito no livro "House generated by patterns" {w=50%}](../imagens/christopher-alexanderc.png)
...
![Metamodelo de uma API {w=50%}](../imagens/rest-haupt.png)
...
<!--Ficou estranho dizer "temos um sério problema" e "um desseS problemaS", indo pro plural...-->
...
![Modelo de maturidade de Richardson {w=75%}](../imagens/richardson-maturity-model.png)
...
<!--Repare que você já falou de HATEOAS neste capítulo, de modo que ficou bem estranho anunciá-lo assim, como se fosse a primeira vez aqui-->
